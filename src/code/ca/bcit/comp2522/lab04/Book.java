 ...
 * It implements the Comparable, Printable, and Reversible interfaces, allowing the book to be compared, displayed, and reversed.
...
public class Book implements Comparable<Book>, Printable, Reversible {
     ...
     * @return a negative integer, zero, or a positive integer as this book's year is less than, equal to, or greater than the other book's year
     */
    @Override
